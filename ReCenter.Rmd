...
At this stage, I have created first drafts of two mini-volumes of lessons used in my multivariate statistics course in Spring 2021 (copyediting is still required).  These include:

* [Multivariate Modeling](https://lhbikos.github.io/ReC_MultivariateModeling/)
* [Multilevel Modeling](https://lhbikos.github.io/MultilevelModeling/) 

The following mini-volumes are planned for release by January 1, 2022.

* Data Prep
* Analysis of Variance [sample chapter](https://lhbikos.github.io/ReCenterPsychStats/)
* Psychometrics
...
<div class = "col-md-4">
![*Image of a Maskmaker's sewing table with masks-in-progress*.](images/recenter/ReCBookCover.jpg){#id .class width=500}
</div>
</div>
