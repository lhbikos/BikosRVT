...
<span style="color: #651D32;"><em>Click to listen to a screencasted [discussion](https://spu.hosted.panopto.com/Panopto/Pages/Viewer.aspx?pid=8ebf1a26-498e-4012-a63c-acbf0051dbf2&id=afff394a-74d5-4fd3-9829-acbe01395a74&advance=true) about the *ReCentering Psych Stats* research project as well as teaching and technology.</em></span></p>


My (this is Lynette Bikos) participation in the [Academics for Black Survival and Wellness](https://www.academics4blacklives.com/) initiative served as a clarion call for addressing systematic racism in the academy.  Throughout the initiative, A4FL presenters described the problem of *centering whiteness.*  
...
At the end of Fall Quarter 2020, I added three additional items were added to the institution's course evaluations for the students enrolled in the fall quarter stats courses. So that we could analyze the effects across time, all students who were enrolled in the doctoral programs were sent information about a proposed mixed methods evaluation of the decolonization efforts and given an opportunity to "opt out" of having their de-identified course evaluation data used in the evaluation.  Analysis is presently underway. Consensual qualitative research - modified [@spangler_consensual_2012] is being used to analyze the short, narrative responses to the questions about decolonization. Heirarchical linear regression is being used to evaluate the incremental effects of the student's department (clinical vs. I/O), the statistics package being taught (SPSS vs. R), and the intentional approaches to decolonizing the curriculum (precentered vs. recentered).  
...
* [Analysis of Variance](https://lhbikos.github.io/ReCenterPsychStats/) which includes chapters on
...
* [Multivariate Modeling](https://lhbikos.github.io/ReC_MultivariateModeling/), which includes chapters on
  ...
  - Simple moderation
* [Multilevel Modeling](https://lhbikos.github.io/MultilevelModeling/), which includes chapters on
...
* [Psychometrics](https://lhbikos.github.io/ReC_Psychometrics/) is under construction (through November 2021), but presently includes chapters on
...
* reviewing/editing chapters via the Github respository,
...
<div class = "col-md-4">
![*Image of a the ReCentering Psych Stats cover. The image includes four non-normal distributions representing gender diversity, race/ethnicity, sustainability, and peer-reviewed journals.*.](images/recenter/ReCBookCover.jpg){#id .class width=500}
</div>
</div>
...
* At WPA 2021(Virtual) we provided a symposium presentaiton (only 16 minutes) summarizing the quantitative and qualitative evaluation of the first attempt at [recentering ANOVA and psychometrics courses](https://spu.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=857462cf-87c0-4c7d-a4d6-ad03010be71f). 

</div>
<div class = "row">
<div class = "col-md-6">

![*Image of the title slide for a symposium presentation presenting the ReCentering Psych Stats*.](images/recenter/WPAprezi.jpg){#id .class width=500}
</div>
...
<div class = "row">
<div class = "col-md-3">
![*A image of Dr. Bikos and Desta*](images/recenter/teachstats2.jpg){#id .class width=400}
</div>

<div class = "col-md-3">
![*working with Dr. Ullman*](images/recenter/teachstats3.jpg){#id .class width=400}
</div>

<div class = "col-md-3">
![*to solve an HLM statistics dilemma*.](images/recenter/teachstas4.jpg){#id .class width=400}
</div>

<div class = "col-md-3">
![*It was complicated.*](images/recenter/teachstats.jpg){#id .class width=400}
