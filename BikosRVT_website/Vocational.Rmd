...
<div class = "blue">
# CALLED!  SPU's Online Field Guide<br>
</div>
<div class = "row">
...
The Bikos RVT runs the campus-wide vocational intervention, **CALLED!  SPU’s Online Field Guide** (the OFG). The OFG was born out of a 3-year, campus-wide, task force that sought to meet the career development needs of the undergraduate students. The task force created a passport-sized, paper, [Field Guide](https://spu.edu/~/media/administration/center-career-calling/Vocation%20Field%20Guide/low%20res%20Vocation%20Field%20Guide.ashx); the BikosRVT translated it into Canvas. <br>

Each year, undergraduate students are presented with 6-10 activities (we avoid calling them "assignments") that assist them with adjusting to campus/college, self-exploration, exploring the world-of-work, job search skills, and discernment. The OFG remains available to the student after graduation.<br>
...
<div class = "col-md-4">
<br><br>
![*Image of the cover of the paper version of the Field Guide*.](FieldGuide.png){#id .class width=250}
</div>
</div>
...
<div class = "blue">
# Voc Psych Posters<br>
</div>
<div class = "row">

<center>
![*Image of the a poster evaluating the random clinical trial associated with the OFG*.](OFG_APAposter2019.png){#id .class width=800}
<center>

<br><br>

<center>
![*Image of the a poster evaluating mediated and moderated models of calling in international immersion learning returnees*.](CallingModsAPA2014.jpg){#id .class width=800}
<center>

<br><br>

<center>
![*Image of the a poster reporting results of a qualitative investigation into the career development experiences of repatriation missionary kids*.](CQR_MKposterAPA2012.jpg){#id .class width=800}
<center>
